...
Generated at: 2026-03-05T08:30:38.990344+00:00
Project: king-fast-1
Milestone: 1
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Create a new user with valid name and email, expect 201 with user object returned",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "get_users_empty_database",
        "category": "HAPPY_PATH",
        "endpoint": "/users",
        "method": "GET",
        "description": "Retrieve all users from a fresh database, expect 200 with an empty array",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "get_users_after_creation",
        "category": "HAPPY_PATH",
        "endpoint": "/users",
        "method": "GET",
        "description": "Create a user then retrieve all users, expect 200 with a non-empty array",
        "setup": {
            "endpoint": "/users",
            "method": "POST",
            "body": {
